...
const Card: React.FC<CardProps> = ({ title, description, image }) => {
  return (
    <div className="bg-white rounded-xl sm:w-full md:w-[372px] min-h-[166px] md:h-[240px] border-4 border-gray-200 transform transition-transform duration-300 hover:rotate-2 hover:-translate-y-2 overflow-hidden">
