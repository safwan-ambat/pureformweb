...
const Card: React.FC<CardProps> = ({ number, title, description, tilt = '' }) => {
  return (
    <div className={`md:m-2 m-1 ${tilt}`}>
      <div className="relative p-[4px] rounded-[12px] md:rounded-[16px] bg-gradient-to-b from-[rgb(216,216,216)] to-[rgb(148,148,148)] md:w-[250px] md:min-h-[212px]">
        <div className="bg-white rounded-[10px] md:rounded-[13px] p-[10px_10px_16px_16px] md:p-[16px_16px_24px_24px] flex flex-col justify-between min-h-[150px] md:min-h-[212px]">
